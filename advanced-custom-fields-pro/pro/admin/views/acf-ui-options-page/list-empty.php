...
$acf_options_pages_desc = sprintf(
	/* translators: %s URL to ACF options page documentation */
	__( 'ACF <a href="%s" target="_blank">options page</a> are custom admin page for managing global settings via fields. You can create multiple page and sub-page.', 'acf' ),
	acf_add_url_utm_tags( 'https://www.advancedcustomfields.com/resources/options-page/', 'docs', 'no-options-page' )
);

$acf_getting_started = sprintf(
	/* translators: %s url to getting started guide */
	__( 'New to ACF? Take a look at our <a href="%s" target="_blank">getting started guide</a>.', 'acf' ),
	acf_add_url_utm_tags( 'https://www.advancedcustomfields.com/resources/getting-started-with-acf/', 'docs', 'no-options-page' )
);
?>
<script>document.body.classList.add('acf-no-options-page');</script>
