...
if ( ! class_exists( 'ACF_Admin_UI_Options_Pages' ) ) :
	...
	class ACF_Admin_UI_Options_Pages extends ACF_Admin_Internal_Post_Type_List {
		 ...
		 * @var string
		 */
		public $admin_body_class = 'acf-admin-options-page';
		...
		public function current_screen() {
			...
			if ( ! acf_get_user_setting( 'options-page-first-run', false ) ) {
				...
				acf_update_user_setting( 'options-page-first-run', true );
			}
		}
			...
			switch ( $action ) {
				case 'acfactivatecomplete':
					$text = sprintf(
						...
						_n( 'Options page activated.', '%s options page activated.', $count, 'acf' ),
						$count
					);
					break;
				case 'acfdeactivatecomplete':
					$text = sprintf(
						...
						_n( 'Options page deactivated.', '%s options page deactivated.', $count, 'acf' ),
						$count
					);
					break;
				case 'acfduplicatecomplete':
					$text = sprintf(
						...
						_n( 'Options page duplicated.', '%s options page duplicated.', $count, 'acf' ),
						$count
					);
					break;
				case 'acfsynccomplete':
					$text = sprintf(
						...
						_n( 'Options page synchronized.', '%s options page synchronized.', $count, 'acf' ),
						$count
					);
					break;
			}
