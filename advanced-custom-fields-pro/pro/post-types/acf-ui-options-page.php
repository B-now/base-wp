...
if ( ! class_exists( 'ACF_UI_Options_Page' ) ) {
	...
	class ACF_UI_Options_Page extends ACF_Internal_Post_Type {
		...
		/**
		 * Register activated options page.
		 *
		 * @since 6.2
		 */
		public function register_ui_options_pages() {
			...
			// Register parent page first so that child page can be registered properly.
		...
		/**
		 * Updates the settings for ACF UI options page.
		 *
		 * @since 6.2
		 *
		...
		/**
		 * Sets up the local JSON functionality for options page.
		 *
		 * @since 6.2
		 *
		...
		/**
		 * Includes all local JSON options page.
		 *
		 * @since 6.1
		 *
		 * @return void
