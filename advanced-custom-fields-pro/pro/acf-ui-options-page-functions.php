<?php
/**
 * Helper/wrapper Functions for ACF UI Options page.
 *
 * @package ACF
 */
...
/**
 * Returns and array of ACF UI options page for the given $filter.
 *
 * @since 6.2
 *
...
/**
 * Returns an array of raw ACF UI options page.
 *
 * @since 6.2
 *
 * @return array
...
/**
 * Returns a filtered array of ACF UI options page based on the given $args.
 *
 * @since 6.2
 *
 * @param array $ui_options_pages An array of ACF UI options page.
