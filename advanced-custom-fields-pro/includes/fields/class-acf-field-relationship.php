...
if ( ! class_exists( 'acf_field_relationship' ) ) :
	...
	class acf_field_relationship extends acf_field {
		...
		public function initialize() {
			...
			$this->description   = __( 'A dual-column interface to select one or more posts, page, or custom post type items to create a relationship with the item that you\'re currently editing. Includes options to search and filter.', 'acf' );
