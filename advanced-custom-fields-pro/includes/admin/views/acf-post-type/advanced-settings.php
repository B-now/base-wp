		...
		case 'visibility':
			...
			acf_render_field_wrap(
				array(
					...
					'instructions' => __( 'Sets whether posts should be excluded from search results and taxonomy archive page.', 'acf' ),
					'ui'           => true,
				)
			);
		...
		case 'urls':
			...
			acf_render_field_wrap(
				array(
					...
					'key'          => 'page',
					'prefix'       => 'acf_post_type[rewrite]',
					'value'        => isset( $acf_post_type['rewrite']['page'] ) ? $acf_post_type['rewrite']['page'] : true,
